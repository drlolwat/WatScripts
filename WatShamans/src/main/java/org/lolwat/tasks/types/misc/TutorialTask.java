                ...
                switch (conf) {
                    ...
                    case 3:
                        if(Dialogues.getOptions() == null) {
                            ...
                            Dialogues.clickOption("I am an experienced player.");
                        }
                        break;
                    case 333333:
                        //open settings
                    ...
                    case 260:
                        // 3081, 9506
                        Area a = new Tile(3081,  9506, 0).getArea(6);
                    ...
                    case 310:
                        tin = GameObjects.closest(g -> {
                            if (g == null || g.getName() == null)
                                return false;
                            if (!g.getName().equals("Copper rocks"))
                                return false;
                    ...
                    case 520:
                        if (Bank.isOpen()) {
                            ...
                            if (Widgets.getWidget(POLL_OPEN) == null || !Widgets.getWidget(POLL_OPEN).isVisible()) {
                    ...
                    case 670:
                        if (Dialogues.getOptions() == null) {
                            ...
                            if(Dialogues.getOptions()[0].equals("Yes.")) {
                                ...
                                Dialogues.clickOption("No, I'm not planning to do that.");
                            }
                        }
                        break;
                    case 1000:
